...
> **_NOTE:_** By default, this template uses Pinecone as vector store, but you can turn on Supabase pgvector or Metal easily. This means you only need to fill out either:
>
> - Pinecone API key
> - Supabase API key
> - Metal API Key
...
In `QAModel.tsx`, replace `/api/qa-pinecone` with `/api/qa-metal`.
